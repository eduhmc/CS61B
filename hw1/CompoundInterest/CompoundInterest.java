...
public class CompoundInterest {
    ...
    static double futureValueReal(double presentValue, double rate,
        ...
        return presentValue*Math.pow((1+rate*0.01),targetYear-THIS_YEAR) * Math.pow((1-inflationRate*0.01),targetYear-THIS_YEAR);
    }
    ...
    static void printDollarFV(int targetYear, double returnRate,
                              double inflationRate) {
        double nominalDollarValue = futureValue(1,returnRate,targetYear); // replace 0 with your code; // replace 0 with your code
